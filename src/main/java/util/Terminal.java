...
public class Terminal {
     ...
     * @throws TerminalException (de type RuntimeException) si erreur d'ecriture<BR>
     ...
     * @throws TerminalException (de type RuntimeException) si erreur d'zcriture
     */
    ...
    /**
     * Cette mzthode lit une chaine de caractere
     *
     * @return String la chaine saisie dans la console d'execution
     * @throws TerminalException (de type RuntimeException) si erreur de lecture
     */
     ...
     * @throws TerminalException (de type RuntimeException) si la saisie n'est pas un entier ou erreur de lecture
     */
     ...
     * @throws TerminalException (de type RuntimeException) si erreur de lecture. <BR>
     ...
     * @throws TerminalException (de type RuntimeException) si la valeur saisie n'est pas un double ou ereur de lecture.
     */
